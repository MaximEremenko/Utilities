...
class GaussianKDE {
  constructor(dataset, bw_method = "scott", weights = null) {
    ...
    this.d = dataset.length;  // number of dimensions
    this.n = dataset[0].length;  // number of samples
    console.log("Inside GaussianKDE constructor: d =", this.d, "n =", this.n);
  ...
  // Other methods (resample, integrateGaussian, integrateKDE, marginal) remain unchanged.
